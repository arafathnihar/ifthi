...
<?php } ?>
	<div id="form-login-submit" class="control-group">
		<div class="controls">
			<?php echo $this->cart->displayButton(JText::_('HIKA_LOGIN'), 'login', @$this->params, '', 'var button = document.getElementById(\'login_view_action\'); if(button) button.value=\'login\'; document.hikashop_checkout_form.submit();return false;', '', 0, 1, 'btn btn-primary'); ?>
		</div>
	</div>
</div>
<?php } ?>
