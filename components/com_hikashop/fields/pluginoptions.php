...
class JFormFieldPluginoptions extends JFormField{
	...
	protected function getInput() {
		...
		$text = '<a style="float:left;" title="'.JText::_('HIKASHOP_OPTIONS').'"  href="'.JRoute::_('index.php?option=com_hikashop&ctrl=plugins&fromjoomla=1&task=edit&name='.$name.'&plugin_type='.$group).'" >'.JText::_('HIKASHOP_OPTIONS').'</a>';
		return $text;
	}
}
