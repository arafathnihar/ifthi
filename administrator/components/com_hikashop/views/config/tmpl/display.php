...
<?php if(HIKASHOP_J30) { ?>
				<tr>
					...
					<td><?php
						$options = array(
							...
							JHTML::_('hikaselect.option', 'bootstrap', JText::_('boostrap'))
						);
				...
				<tr>
					...
					<td><?php
						echo JHTML::_('hikaselect.booleanlist',  'config[bootstrap_forcechosen]','',$this->config->get('bootstrap_forcechosen',1));
					?></td>
				</tr>
<?php } ?>
				<tr>
