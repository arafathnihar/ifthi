			...
			<legend><?php echo JText::_( 'HIKASHOP_ORDER' ); ?></legend>
				<table class="admintable table" cellspacing="1">
					...
					<tr>
						...
						<td>
							<?php if(hikashop_level(1)){
								echo JHTML::_('hikaselect.booleanlist', 'config[allow_payment_button]','',$this->config->get('allow_payment_button'));
							}else{
								echo '<small style="color:red">'.JText::_('ONLY_COMMERCIAL').'</small>';
							} ?>
						</td>
				...
				<table class="admintable table" cellspacing="1">
					...
					<tr>
						...
						<td><?php if(hikashop_level(2)){ ?>
							...
							<input id="hikashop_watermark_image" type="file" name="watermark[]" size="30" /><br/><?php
