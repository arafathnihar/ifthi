...
<form onsubmit="if(document.getElementById('hikashop_default_image').value!='' || (document.getElementById('hikashop_watermark_image') && document.getElementById('hikashop_watermark_image').value!='')){document.getElementById('adminForm').enctype='multipart/form-data';}" action="index.php?option=<?php echo HIKASHOP_COMPONENT ?>&amp;ctrl=config" method="post"  name="adminForm" id="adminForm">
