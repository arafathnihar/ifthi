...
<fieldset class="adminform" id="htmlfieldset_<?php echo $this->type; ?>">
	...
	if(($this->type!='shipping' || !empty($this->order->order_shipping_address_id)) && !empty($this->order->$name)){
		...
		?>
		<div style="float:right">
			<a class="modal" rel="{handler: 'iframe', size: {x: 760, y: 480}}" href="<?php echo hikashop_completeLink('order&task=address&type='.$this->type.'&order_id='.$this->order->order_id,true);?>">
