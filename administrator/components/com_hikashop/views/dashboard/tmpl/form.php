...
<form action="index.php" method="post" name="adminForm" id="adminForm">
	<table class="admintable" cellspacing="1">
		...
		<tr>
			...
			<td>
				<?php echo JHTML::_('calendar', hikashop_getDate((@$this->element->widget_params->start?@$this->element->widget_params->start:''),'%Y-%m-%d %H:%M'), 'data[widget][widget_params][start]','period_start','%Y-%m-%d %H:%M','size="20"'); ?>
			</td>
		</tr>
		<tr>
			<td class="key" >
			...
			<td>
				<?php echo JHTML::_('calendar', hikashop_getDate((@$this->element->widget_params->end?@$this->element->widget_params->end:''),'%Y-%m-%d %H:%M'), 'data[widget][widget_params][end]','period_end','%Y-%m-%d %H:%M','size="20"'); ?>
			</td>
		</tr>
		<tr>
			<td class="key" >
