...
<?php } ?>
				<table class="admintable table" style="margin:auto">
					...
					<tr>
						...
						<td>
							<?php echo JHTML::_('calendar', (@$this->element->badge_start?hikashop_getDate(@$this->element->badge_start,'%Y-%m-%d %H:%M'):''), 'data[badge][badge_start]','badge_start','%Y-%m-%d %H:%M','size="20"'); ?>
						</td>
					</tr>
					<tr>
						<td class="key">
						...
						<td>
							<?php echo JHTML::_('calendar', (@$this->element->badge_end?hikashop_getDate(@$this->element->badge_end,'%Y-%m-%d %H:%M'):''), 'data[badge][badge_end]','badge_end','%Y-%m-%d %H:%M','size="20"'); ?>
						</td>
					</tr>
					<tr>
						<td class="key">
