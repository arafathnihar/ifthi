...
class ProductViewProduct extends hikashopView
{
	...
	function listing(){
		...
		$this->toolbar = array(
			...
			array('name' => 'custom', 'icon' => 'copy', 'alt' => JText::_('HIKA_COPY'), 'task' => 'copy', 'display' => $manage && hikashop_level(2)),
	...
	function galleryimage() {
		...
		$galleryHelper->setRoot(HIKASHOP_MEDIA . 'upload' . DS);
		...
		$pagination = hikashop_get('helper.pagination',$galleryHelper->filecount, $pageInfo->limit->start, $pageInfo->limit->value );
		$this->assignRef('pagination', $pagination);
	}
