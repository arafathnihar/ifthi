...
class ProductController extends hikashopController {
	...
	function __construct($config = array()){
		...
		$this->display=array('unpublish','publish','listing','show','selectcategory','addcategory','selectrelated','addrelated','getprice','addimage','selectimage','addfile','selectfile','variant','updatecart','export','galleryimage','galleryselect');
