...
class hikashopUpdateHelper{
	...
	function installExtensions(){
		...
		if(version_compare(JVERSION,'1.6.0') < ''){
			$query = "SELECT CONCAT(`folder`,`element`) FROM #__plugins WHERE `folder` IN ( 'hikashop','hikashoppayment','hikashopshipping' )  OR `element` LIKE '%hikashop%' OR (`folder`='system' AND `element` IN ('vm_redirect','custom_price','custom_quantity_tax','nossloutsidecheckout'))";
			$query .= " UNION SELECT `module` FROM #__modules WHERE `module` LIKE '%hikashop%'";
			$this->db->setQuery($query);
			$existingExtensions = $this->db->loadResultArray();
		}else{
			$this->db->setQuery("SELECT CONCAT(`folder`,`element`) FROM #__extensions WHERE `folder` IN ( 'hikashop','hikashoppayment','hikashopshipping' ) OR `element` LIKE '%hikashop%' OR (`folder`='system' AND `element` IN ('vm_redirect','custom_price','custom_quantity_tax','nossloutsidecheckout'))");
			if(!HIKASHOP_J25){
				$existingExtensions = $this->db->loadResultArray();
			} else {
...
(1977, 'state___________1977', '北海道', '北海道', '', '01', 'state', 1),
(1978, 'state________1978', '青森県', '青森県', '', '02', 'state', 1),
(1979, 'state________1979', '岩手県', '岩手県', '', '03', 'state', 1),
(1980, 'state________1980', '宮城県', '宮城県', '', '04', 'state', 1),
(1981, 'state________1981', '秋田県', '秋田県', '', '05', 'state', 1),
(1982, 'state________1982', '山形県', '山形県', '', '06', 'state', 1),
(1983, 'state________1983', '福島県', '福島県', '', '07', 'state', 1),
(1984, 'state________1984', '茨城県', '茨城県', '', '08', 'state', 1),
(1985, 'state________1985', '栃木県', '栃木県', '', '09', 'state', 1),
(1986, 'state________1986', '群馬県', '群馬県', '', '10', 'state', 1),
(1987, 'state________1987', '埼玉県', '埼玉県', '', '11', 'state', 1),
(1988, 'state________1988', '千葉県', '千葉県', '', '12', 'state', 1),
(1989, 'state________1989', '東京都', '東京都', '', '13', 'state', 1),
(1990, 'state___________1990', '神奈川県', '神奈川県', '', '14', 'state', 1),
(1991, 'state________1991', '新潟県', '新潟県', '', '15', 'state', 1),
(1992, 'state________1992', '富山県', '富山県', '', '16', 'state', 1),
(1993, 'state________1993', '石川県', '石川県', '', '17', 'state', 1),
(1994, 'state________1994', '福井県', '福井県', '', '18', 'state', 1),
(1995, 'state________1995', '山梨県', '山梨県', '', '19', 'state', 1),
(1996, 'state________1996', '長野県', '長野県', '', '20', 'state', 1),
(1997, 'state________1997', '岐阜県', '岐阜県', '', '21', 'state', 1),
(1998, 'state________1998', '静岡県', '静岡県', '', '22', 'state', 1),
(1999, 'state________1999', '愛知県', '愛知県', '', '23', 'state', 1);";
		$this->db->setQuery($query);
		$this->db->query();

		$query="
INSERT IGNORE INTO `#__hikashop_zone` (`zone_id`, `zone_namekey`, `zone_name`, `zone_name_english`, `zone_code_2`, `zone_code_3`, `zone_type`, `zone_published`) VALUES
(2000, 'state________2000', '三重県', '三重県', '', '24', 'state', 1),
(2001, 'state________2001', '滋賀県', '滋賀県', '', '25', 'state', 1),
(2002, 'state________2002', '京都府', '京都府', '', '26', 'state', 1),
(2003, 'state________2003', '大阪府', '大阪府', '', '27', 'state', 1),
(2004, 'state________2004', '兵庫県', '兵庫県', '', '28', 'state', 1),
(2005, 'state________2005', '奈良県', '奈良県', '', '29', 'state', 1),
(2006, 'state___________2006', '和歌山県', '和歌山県', '', '30', 'state', 1),
(2007, 'state________2007', '鳥取県', '鳥取県', '', '31', 'state', 1),
(2008, 'state________2008', '島根県', '島根県', '', '32', 'state', 1),
(2009, 'state________2009', '岡山県', '岡山県', '', '33', 'state', 1),
(2010, 'state________2010', '広島県', '広島県', '', '34', 'state', 1),
(2011, 'state________2011', '山口県', '山口県', '', '35', 'state', 1),
(2012, 'state________2012', '徳島県', '徳島県', '', '36', 'state', 1),
(2013, 'state________2013', '香川県', '香川県', '', '37', 'state', 1),
(2014, 'state________2014', '愛媛県', '愛媛県', '', '38', 'state', 1),
(2015, 'state________2015', '高知県', '高知県', '', '39', 'state', 1),
(2016, 'state________2016', '福岡県', '福岡県', '', '40', 'state', 1),
(2017, 'state________2017', '佐賀県', '佐賀県', '', '41', 'state', 1),
(2018, 'state________2018', '長崎県', '長崎県', '', '42', 'state', 1),
(2019, 'state________2019', '熊本県', '熊本県', '', '43', 'state', 1),
(2020, 'state________2020', '大分県', '大分県', '', '44', 'state', 1),
(2021, 'state________2021', '宮崎県', '宮崎県', '', '45', 'state', 1),
(2022, 'state___________2022', '鹿児島県', '鹿児島', '', '46', 'state', 1),
(2023, 'state________2023', '沖縄県', '沖縄県', '', '47', 'state', 1),
