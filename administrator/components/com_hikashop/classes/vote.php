		...
		if(pseudo_comment == "" || (email_comment_bool == 1 && verif_mail == false)){ //if not connected
			...
			if(hikashop_vote_vote_comment == 1){ // Save comment & vote.
				...
				if(hikashop_vote_comment == "" || hikashop_vote_ok == 0){ // Just show a message
					...
					try{
						new Ajax(\'' . $baseUrl . 'vote_type=\'+vote_type+\'&email_comment=\'+email_comment+\'&pseudo_comment=\'+pseudo_comment+\'&hikashop_vote_type=both&hikashop_vote=\'+hikashop_vote+\'&hikashop_vote_user_id=\'+hikashop_vote_user_id+\'&hikashop_vote_ref_id=\'+hikashop_vote_ref_id+\'&hikashop_vote_comment=\'+hikashop_vote_comment, {method: \'get\', onSuccess: function(status){if(status == 1){document.getElementById("hikashop_vote_status_form").innerHTML = " ' . JText::_('THANKS_FOR_PARTICIPATION', true) . '";document.getElementById("hikashop_vote_comment").value="";}else if(status == 3){document.getElementById("hikashop_vote_status_form").innerHTML = " ' . JText::_('MUST_HAVE_BUY_TO_VOTE', true) . '";}	else if(status == 2){document.getElementById("hikashop_vote_status_form").innerHTML = " ' . JText::_('REACH_LIMIT_OF_COMMENT', true) . '";}else{document.getElementById("hikashop_vote_status_form").innerHTML = " ' . JText::_('VOTE_ERROR', true) . '";}}}).request();
					}catch(err){
						new Request({url:\'' . $baseUrl . 'vote_type=\'+vote_type+\'&email_comment=\'+email_comment+\'&pseudo_comment=\'+pseudo_comment+\'&hikashop_vote_type=both&hikashop_vote=\'+hikashop_vote+\'&hikashop_vote_user_id=\'+hikashop_vote_user_id+\'&hikashop_vote_ref_id=\'+hikashop_vote_ref_id+\'&hikashop_vote_comment=\'+hikashop_vote_comment, method: \'get\', onSuccess: function(status){if(status == 1){document.getElementById("hikashop_vote_status_form").innerHTML = " ' . JText::_('THANKS_FOR_PARTICIPATION', true) . '";document.getElementById("hikashop_vote_comment").value="";}	else if(status == 3){document.getElementById("hikashop_vote_status_form").innerHTML = " ' . JText::_('MUST_HAVE_BUY_TO_VOTE', true) . '";}else if(status == 2){document.getElementById("hikashop_vote_status_form").innerHTML = " ' . JText::_('REACH_LIMIT_OF_COMMENT', true) . '";}else{document.getElementById("hikashop_vote_status_form").innerHTML = " ' . JText::_('VOTE_ERROR', true) . '";}}}).send();
					}
					setTimeout("document.location=\''.$current_url.'\'",2250);
				}
			}else if(hikashop_vote_comment != ""){
				try{
					new Ajax(\'' . $baseUrl . 'vote_type=\'+vote_type+\'&email_comment=\'+email_comment+\'&pseudo_comment=\'+pseudo_comment+\'&hikashop_vote_type=comment&hikashop_vote_user_id=\'+hikashop_vote_user_id+\'&hikashop_vote_ref_id=\'+hikashop_vote_ref_id+\'&hikashop_vote_comment=\'+hikashop_vote_comment, {method: \'get\', onSuccess: function(status){if(status == 1){document.getElementById("hikashop_vote_status_form").innerHTML = " ' . JText::_('THANKS_FOR_COMMENT', true) . '";document.getElementById("hikashop_vote_comment").value="";}else if(status == 3){document.getElementById("hikashop_vote_status_form").innerHTML = " ' . JText::_('MUST_HAVE_BUY_TO_VOTE', true) . '";}else if(status == 2){document.getElementById("hikashop_vote_status_form").innerHTML = " ' . JText::_('REACH_LIMIT_OF_COMMENT', true) . '";}else{document.getElementById("hikashop_vote_status_form").innerHTML = " ' . JText::_('VOTE_ERROR', true) . '";}}}).request();
				}catch(err){
					new Request({url:\'' . $baseUrl . 'vote_type=\'+vote_type+\'&email_comment=\'+email_comment+\'&pseudo_comment=\'+pseudo_comment+\'&hikashop_vote_type=comment&hikashop_vote_user_id=\'+hikashop_vote_user_id+\'&hikashop_vote_ref_id=\'+hikashop_vote_ref_id+\'&hikashop_vote_comment=\'+hikashop_vote_comment, method: \'get\', onSuccess: function(status){if(status == 1){document.getElementById("hikashop_vote_status_form").innerHTML = " ' . JText::_('THANKS_FOR_COMMENT', true) . '";document.getElementById("hikashop_vote_comment").value="";}else if(status == 3){document.getElementById("hikashop_vote_status_form").innerHTML = " ' . JText::_('MUST_HAVE_BUY_TO_VOTE', true) . '";}else if(status == 2){document.getElementById("hikashop_vote_status_form").innerHTML = " ' . JText::_('REACH_LIMIT_OF_COMMENT', true) . '";}else{document.getElementById("hikashop_vote_status_form").innerHTML = " ' . JText::_('VOTE_ERROR', true) . '";}}}).send();
				}
				setTimeout("document.location=\''.$current_url.'\'",2250);
			}else{
