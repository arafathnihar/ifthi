...
class plgHikashoppaymentCMCIC extends JPlugin
{
	...
	function onAfterOrderConfirm(&$order,&$methods,$method_id) {
		...
		if(!isset($method->payment_params->bank) || !isset($urls[$method->payment_params->bank]) ) {
	...
	function onPaymentNotification(&$statuses){
		...
		$mailer->setSubject(JText::sprintf('PAYMENT_NOTIFICATION_FOR_ORDER','CMCIC',$payment_status,$dbOrder->order_number));
	...
	function onPaymentConfiguration(&$element){
		...
		$this->toolbar = array(
			...
			'cancel',
			'|',
			array('name' => 'pophelp', 'target' =>'payment-cmcic-form')
		);
