...
class plgContentHikashopsocial extends JPlugin
{
	...
	function _addFacebookButton( &$plugin){
		...
		if($plugin->params['fb_font']==1){ $options.='font=lucida%20grande&amp;'; $xfbml_options.='data-font="lucida grande" '; }
		if($plugin->params['fb_font']==2){ $options.='font=segoe%20ui&amp;'; $xfbml_options.='data-font="segoe ui" ';}
		if($plugin->params['fb_font']==3){ $options.='font=tahoma&amp;'; $xfbml_options.='data-font="tahoma" '; }
		if($plugin->params['fb_font']==4){ $options.='font=trebuchet%2Bms&amp;'; $xfbml_options.='data-font="trebuchet ms" '; }
		...
		$url=urlencode(hikashop_currentURL('',false));
		...
		$this->meta['property="og:url"']='<meta property="og:url" content="'.hikashop_currentURL().'" />';
