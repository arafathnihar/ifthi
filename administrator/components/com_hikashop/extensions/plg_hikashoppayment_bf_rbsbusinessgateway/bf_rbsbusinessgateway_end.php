...
<div class="hikashop_rbsworldpay_end" id="hikashop_rbsworldpay_end">
	...
	<form id="hikashop_rbsworldpay_form" name="hikashop_rbsworldpay_form" action="<?php echo $method->payment_params->url;?>" method="post">
		<div id="hikashop_rbsworldpay_end_image" class="hikashop_rbsworldpay_end_image">
			<input id="hikashop_rbsworldpay_end_button" <?php echo $method->payment_params->redirect_button; ?> type="submit" class="btn btn-primary" value="" name="" alt="Click to pay with RBS Worldpay - it is fast, free and secure!" />
		</div>
		<?php
