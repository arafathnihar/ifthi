...
<head>
	...
	<script type="text/javascript" src="<?php echo AUri::base() ?>/template/angie/js/jquery.js"></script>
	<script type="text/javascript" src="<?php echo AUri::base() ?>/template/angie/js/bootstrap.min.js"></script>
	<link rel="stylesheet" type="text/css" href="<?php echo AUri::base() ?>/template/angie/css/bootstrap.min.css" />
	<link rel="stylesheet" type="text/css" href="<?php echo AUri::base() ?>/template/angie/css/bootstrap-responsive.min.css" />
	<link rel="stylesheet" type="text/css" href="<?php echo AUri::base() ?>/template/angie/css/footer.css" />
</head>
<body>
	<div id="wrap">
