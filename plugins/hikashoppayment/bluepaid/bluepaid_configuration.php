...
<tr>
	...
	<td>
		...
		<br/>
		<a href="#" onclick="new Ajax('<?php echo hikashop_completeLink('plugins&plugin_type=payment&task=edit&name='.$this->data['bluepaid'].'&subtask=ips',true);?>',{ method: 'get', onComplete: function(result) { document.getElementById('bluepaid_ips').value=result; }}).request();return false;">
