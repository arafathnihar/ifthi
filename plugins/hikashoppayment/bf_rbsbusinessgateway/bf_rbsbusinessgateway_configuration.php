...
<tr>
	<td class="key">
		<label for="data[payment][payment_params][displayForGuests]">
			<?php echo 'Display for guest users'; ?>
		</label>
	</td>
	<td>
		<?php echo JHTML::_('hikaselect.booleanlist', "data[payment][payment_params][displayForGuests]" , '',@$this->element->payment_params->displayForGuests	); ?>
	</td>
</tr>
<tr>
	<td class="key">
