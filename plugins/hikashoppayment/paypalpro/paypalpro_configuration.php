...
<tr>
	<td class="key">
		<label for="data[payment][payment_params][send_notification]">
			<?php echo JText::_( 'ORDER_NOTIFICATION' ); ?>
		</label>
	</td>
	<td>
		<?php echo JHTML::_('hikaselect.booleanlist', "data[payment][payment_params][send_notification]" , '',@$this->element->payment_params->send_notification	); ?>
	</td>
</tr>
<tr>
	<td class="key">
